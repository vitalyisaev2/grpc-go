...
// relative to the github.com/vitalyisaev2/grpc-go directory in the user's GOPATH.
// If rel is already absolute, it is returned unmodified.
func abs(rel string) string {
	if filepath.IsAbs(rel) {
		return rel
	}
	v, err := goPackagePath("github.com/vitalyisaev2/grpc-go")
	if err != nil {
		log.Fatalf("Error finding github.com/vitalyisaev2/grpc-go/testdata directory: %v", err)
	}
